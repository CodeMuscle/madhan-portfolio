...
export const ContactSection = () => {
  return (
    <div className="py-16 pt-12 lg:py-24 lg:pt-20 relative z-0">
      <div className="container">
        <div className="bg-gradient-to-r from-emerald-300 to-sky-400 text-gray-900 py-8 px-10 rounded-3xl text-center md:text-left relative overflow-hidden">
          ...
          <div className="flex flex-col md:flex-row gap-8 md:gap-16 items-center z-10">
            ...
            <div className="">
              <button className="inline-flex gap-2 text-white bg-gray-900 items-center px-6 h-12 rounded-xl w-max border border-gray-900">
                <a
                  href="mailto:ganeshgovind11@gmail.com"
