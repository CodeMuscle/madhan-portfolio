                ...
                <div className="lg:pb-16">
                  ...
                  <ul className="mt-4 md:mt-5 flex flex-col gap-4">
                    {project.results.map((result) => (
                      <li
                        key={result.title}
                        className="flex flex-row gap-2 text-sm md:text-base text-white/50"
                      >
                  ...
                  <a href={project.link} className="">
                    <button className="bg-white text-gray-950 h-12 w-full md:w-fit md:px-6 rounded-xl font-semibold inline-flex items-center justify-center gap-2 mt-8">
